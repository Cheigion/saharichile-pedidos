...
def recibir_respuesta():
    ...
    if not fila:
        resp.message("🤖 No encontramos un pedido con tu numero. Visita saharichile.netlify.app para hacer un pedido 🍱")
        return str(resp)
    ...
    if mensaje in ["SI", "SÍ", "S", "YES", "OK", "CONFIRMO", "CONFIRMAR"]:
        ...
        resp.message(
            ...
            f"Si cambias de opinion puedes hacer un nuevo pedido en saharichile.netlify.app 🍱"
        )
    else:
        resp.message(
